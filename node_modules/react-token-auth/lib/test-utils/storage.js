...
exports.createAsyncTestStorage = exports.createTestStore = void 0;
exports.createTestStore = function (initData) {
    ...
    return { getItem: getItem, setItem: setItem, removeItem: removeItem, getData: getData };
};
exports.createAsyncTestStorage = function (initData) {
    if (initData === void 0) { initData = {}; }
    var data = initData;
    var getData = function () { return data; };
